...
const buttonList = ref<ButtonItem[]>([
  {
    ...
    url: () => import('@/assets/icons/maikefeng.svg')
  },
  {
    id: 1,
    name: '摄像头',
    icon: 'iconfont icon-shexiangtou',
    url: () => import('@/assets/icons/shexiangtou.svg')
  },
  {
    id: 2,
    name: '聊天',
    icon: 'iconfont icon-liaotiankuang',
    url: () => import('@/assets/icons/liaotiankuang.svg')
  }
])
...
<template>
  <div class="online-container">
    <iframe src="/static/student.html" frameborder="0" scrolling="no"></iframe>
...
@import url('../../styles/cource/onlineClass.scss');
</style>
