  ...
  [
    {
      ...
      path: '/teacher/watch',
      url: () => import('@/assets/icons/eye.svg')
    },
    {
      index: 1,
      title: '组卷中心',
    ...
    },
    {
      index: 2,
      title: '在线课堂',
      className: 'iconfont icon-zaixianketang',
      path: '/teacher/online-class',
      url: () => import('@/assets/icons/zaixianketang.svg')
    },
    {
      index: 3,
      title: '教学课件',
      className: 'iconfont icon-kejian',
      path: '/teacher/teach',
      url: () => import('@/assets/icons/kejian.svg')
    },
    {
      index: 4,
      title: '消息中心',
      ...
      path: '/teacher/news',
      url: () => import('@/assets/icons/new.svg')
    },
    {
      index: 5,
      title: '任务发布',
      className: 'iconfont icon-renwu',
      path: '/teacher/publish',
      url: () => import('@/assets/icons/renwu.svg')
    },
    {
      index: 6,
      title: '反馈收集',
      ...
      url: () => import('@/assets/icons/radio.svg')
    },
    {
      index: 7,
      title: '发布考勤',
      ...
      url: () => import('@/assets/icons/tag.svg')
    }
  ],
  [
    {
      ...
      path: '/teacher/guide',
      url: () => import('@/assets/icons/map.svg')
    },
    {
      index: 9,
      title: '账号设置',
      ...
      url: () => import('@/assets/icons/setting.svg')
    }
  ]
])
